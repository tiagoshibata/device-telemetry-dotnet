    ...
    public class Rule : IComparable<Rule>
    {
        ...
        public Rule(JToken json)
        {
            try
            {
                ...
                if (jsonRule["ETag"] != null &&
                    jsonRule["Id"] != null &&
                    jsonRule["DateCreated"] != null &&
                    jsonRule["DateModified"] != null)
                {
                    this.ETag = jsonRule["ETag"].ToString();
                    this.Id = jsonRule["Id"].ToString();
                    this.DateCreated = jsonRule["DateCreated"].ToString();
                    this.DateModified = jsonRule["DateModified"].ToString();
                }
                else
                {
                    this.ETag = string.Empty;
