...
1. Open the solution using the `device-telemetry.sln` file.
...
We also provide a
[Java version](https://github.com/Azure/device-telemetry-java)
...
[device-telemetry.sln.DotSettings](device-telemetry.sln.DotSettings)
